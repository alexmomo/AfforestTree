			...
			<div class="columns">
				...
				<div class="column three-fourths">
					<div class="boxed-group">
						...
						<form id="profile_9276604" class="setting_form columns js-uploadable-container js-upload-avatar-image is-default" method="post" data-upload-policy-url="/upload/policies/avatars" action="setting/profile.do" accept-charset="UTF-8">
